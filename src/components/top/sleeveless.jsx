    ...
    return (
        <>
            <Swiper
                ...
                loop={false}
            >
                {list.sleeveless && list.sleeveless.length === 0 ? (
                    <>
                        <h1 className="text-center" style={{ padding: '2rem' }}>
                            You have no sleeveless!
                        </h1>
                    </>
                ) : null}
